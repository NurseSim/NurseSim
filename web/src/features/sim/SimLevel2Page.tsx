...
export const SimLevel2Page: React.FC = () => {
  ...
  async function startOrResumeLevel2(retake = false) {
    setLoading(true);
    setErrorMsg(null);
    ...
    try {
      ...
      if (!res.ok)
        throw new Error(
          "Failed to start level 2 attempt: " + res.statusText
        );
      ...
      console.error(e);
      setErrorMsg("Could not start Level 2. Is the backend running?");
    } finally {
      setLoading(false);
    }
  }
        ...
        {showIntro && (
          <div className="popup-overlay">
            <div className="popup-box introduction-box">
              <h2>Level 2 — The Turning Point</h2>
              <p>
          ...
          <div className="quiz-popup">
            ...
            {!loading && !errorMsg && !step && (
              <div style={{ textAlign: "center" }}>
                <h1 className="question">Level 2 Complete!</h1>
                ...
                {scorePercent !== null ? (
                  <>
                    ...
                    <button
                      className="close-button"
                      onClick={() => startOrResumeLevel2(true)}
                    >
                      Retake Level 2
                    </button>
                  </>
